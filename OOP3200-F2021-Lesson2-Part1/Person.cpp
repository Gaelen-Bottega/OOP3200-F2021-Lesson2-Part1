...
{
	// option 2: Long way to initialize
	// m_name = name;
	// m_age = age;
...
/// <summary>
/// This method takes one string parameter, age, and sets the m_age variable to its value
/// </summary>
...
/// <summary>
/// This method outputs m_name value and says hello
/// </summary>
